...
/*   Updated: 2024/07/30 00:18:16 by iassil           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_key_hook(mlx_key_data_t keycube, void *param)
{
	...
	else if (keycube.key == MLX_KEY_M && keycube.action == MLX_RELEASE)
		ft_press_and_release_mouse_key(keycube, &cube->mouse_key);
	else
		return ;
	ft_move_player(cube);
}
